...
pub fn Parser() -> Parser {
    let http_parser = struct_http_parser {
        _type_flags: 0,
        state: 0,
        header_state: 0,
        index: 0,
...
extern fn on_header_field(http_parser: *http_parser, at: *u8, length: size_t) ->
        c_int {
    unsafe {
...
extern fn on_header_value(http_parser: *http_parser, at: *u8, length: size_t) ->
        c_int {
    unsafe {
